...
def generate_launch_description():
    ...
    teleop_joint_impedance_controller = Node(
        package='controller_manager',
        executable='spawner',
        namespace=namespace,
        arguments=['teleop_joint_impedance_controller', '--controller-manager-timeout', '30'],
        output='screen'
    )
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                ...
                on_exit=[teleop_joint_impedance_controller],
            )
        ),
        Node(
