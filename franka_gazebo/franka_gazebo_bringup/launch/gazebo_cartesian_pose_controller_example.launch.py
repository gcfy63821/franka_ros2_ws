...
def generate_launch_description():
    ...
    cartesian_pose_example_controller = Node(
        package='controller_manager',
        executable='spawner',
        namespace=namespace,
        arguments=['cartesian_pose_example_controller', '--controller-manager-timeout', '30'],
        output='screen'
    )
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                ...
                on_exit=[cartesian_pose_example_controller],
            )
        ),
        Node(
