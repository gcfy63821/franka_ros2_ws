...
"""
Launch file for trajectory following joint impedance controller on real robot.
...
The trajectory file path should be set in the controllers.yaml configuration file
or via ROS parameter after launch.
"""
...
def generate_robot_nodes(context):
    ...
    # Include the existing example.launch.py file with trajectory_following_joint_impedance_controller
    additional_nodes.append(
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'controller_name': 'trajectory_following_joint_impedance_controller',
            }.items(),
        )
    )
